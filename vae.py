...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(784, 400)#400
...
def VAE_loss_function(recon_x, x, mu, logvar):
    ...
    # print("input shapes", recon_x.shape, x.shape)
    recon_loss = F.binary_cross_entropy(recon_x, x.view(-1, 784))
    KLD = -0.5 * torch.sum(logvar - mu **2 - torch.exp(logvar) + 1)
    KLD /= args.batch_size * 784
    # print("loss shapes", recon_loss, KLD)
        ...
        for i, (data, _) in enumerate(test_loader):
            ...
            if i == 0:
                ...
                save_image(
                    ...
                    "resultsFashion/reconstruction_" + str(epoch) + ".png",
                    nrow=n,
                )
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        with torch.no_grad():
            ...
            save_image(
                ...
                sample.view(64, 1, 28, 28), "resultsFashion/sample_" + str(epoch) + ".png"
            )
